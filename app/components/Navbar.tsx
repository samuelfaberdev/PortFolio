...
export default function Navbar() {
  return (
    <header className="animate-fade-down h-24 fixed top-0 p-4 flex items-center justify-between w-full border-b-2 border-neutral-800 bg-[var(--background)] opacity-80">
